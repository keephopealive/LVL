...
<div class="container-fluid viewport">
    ...
    <!-- CONTENT START -->
    <!-- <div class="row">
        <div class='col-sm-5 col-sm-offset-6 col-md-4 col-md-offset-6'>
            <img src='assets/img/labelGris.jpg' class='img-responsive'>
        </div>
    </div> -->
    <div class='row about'>
        <div class='col-sm-5 col-sm-offset-1 col-md-4 col-md-offset-2'>
            <img src='assets/img/lvl_about.jpg' class='img-responsive'>
