...
<div class="container-fluid viewport">
    ...
    <div class='row faqs'>
        <div class='col-sm-8 col-sm-offset-2'>
            ...
            <p class='answer'>Yes.  All standard size Meljac keypads, outlets and proprietary back boxes are UL approved. <br><br>In adherence with standard building codes throughout the United States and  Canada, Meljac outlets are also all tamper-proof.</p>
            ...
            <p class='answer'>Trade professionals can create an order and request a price quote using the <a href="/trade">integrator order entry system</a> on the LVL-USA website.  Here you will also find cut-sheets and more information on Meljac’s plates.  Please note that the order entry tool is currently limited to plates sizes of 5.7”/144 mm.  For any larger plates please contact LVL-USA.</p>

            <br>   
            <br>
            <h3 class='center-block' style="color: rgb(238, 34, 43);">Warnings and Cautions</h3>
            <p class='caution'>Meljac keypads should be installed and/or used in accordance with appropriate electrical codes and regulations.</p>
            <p class='caution'>Meljac keypads and outlets should only be installed by a qualified electrician.</p>
            <p class='caution'>Meljac keypads should be wired in the field as a part of a Class 2 circuit only.</p>
