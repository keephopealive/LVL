    ...
    <div class='row regLogin'>
        <div class="col-sm-10 col-sm-offset-1">
            ...
            <div style="margin-top:50px;">
                <form class="form-inline" action="/tradeEmail">
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" class="form-control" id="name" placeholder="Jane Doe" style="margin-left:10px;">
                    </div>
                    <div class="form-group">
                        <label for="company">Company</label>
                        <input type="text" class="form-control" id="company" placeholder="ABC Development" style="margin-left:10px;">
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" class="form-control" id="email" placeholder="jane.doe@example.com" style="margin-left:10px;">
                    </div>
